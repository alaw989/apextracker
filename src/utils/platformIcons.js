 ...
 *
 * Inline SVG icons for platform selection (PC, Xbox, PlayStation, Switch)
...
export const PlatformIcons = {
  ...
  SWITCH: {
    name: 'Switch',
    svg: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5s5-2.24 5-5V7c0-2.76-2.24-5-5-5zm0 3.5A1.5 1.5 0 1 1 5.5 7 1.5 1.5 0 0 1 7 5.5zM17 2c-1.13 0-2.16.38-3 1v18c.84.62 1.87 1 3 1 2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5zm0 15.5A1.5 1.5 0 1 1 18.5 16 1.5 1.5 0 0 1 17 17.5z"/>
    </svg>`
  }
}
 ...
 * @param {string} platformId - Platform ID (PC, X1, PS4, SWITCH)
